...
autumn_2019_menus = {
    1: {
        "main": [
            "Hot dog with potatoe wedges",
            "Mince and gravy with mashed potatoes",
            "Roast chicken with stuffing and roast poatoes",
            "Moroccan chicken with rice",
            "Fishfingers with chips",
        ],
        "vegitarian": [
            "Quorn sausage in a bun with potatoe wedges",
            "Vegitarian cottage pie with mashed potatoes",
            "Vegetable loaf with roast potatoes and gravy",
            "Soya stir fry with noodles",
            "Cheese and onion quiche with chips",
        ],
        "pudding": [
            "Oaty cookie",
            "Eves pudding with custard",
    ...
    2: {
        "main": [
            "Ham pizza with potatoes",
            "Chilli with rice",
            "Roast gammon with roasted potatoes and gravy",
            "Chicken pasta",
            "Fish and chips",
        ],
        "vegitarian": [
            "Cheese and tomatoe pizza",
            "Macaroni cheese",
            "Vegetable pasty with roast potatoes and gravy",
            "Vegetable pasta bolognaise",
    ...
    3: {
        "main": [
            "Beef burger in a bun with potatoe wedges",
            "Chicken pie with potatoes and gravy",
            "Roast turkey with potatoes and gravy",
            "Beef laragne with garlic bread",
            "Fish and chips",
        ],
        "vegitarian": [
            "Quorn burger with potatoe wedges",
            "Vegetable pie with potatoes and gravy",
            "Quorn fillet with roast potatoes and gravy",
            "Sweet and sour quorn with rice",
